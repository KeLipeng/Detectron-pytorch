...
from detectron.core.config import cfg, merge_cfg_from_file, merge_cfg_from_list, assert_and_infer_cfg
from detectron.core.test_engine import run_inference
from detectron.utils import logging1
...
if __name__ == '__main__':
    ...
    logger = logging1.setup_logging(__name__)
    args = parse_args()
