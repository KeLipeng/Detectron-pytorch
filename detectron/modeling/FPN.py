...
from detectron.modeling.generate_proposals import GenerateProposalsOp
from detectron.modeling.collect_and_distribute_fpn_rpn_proposals import CollectAndDistributeFpnRpnProposalsOp
